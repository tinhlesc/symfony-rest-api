 ...
 */
final class Version20211228152038 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX id_UNIQUE ON movie');
        $this->addSql('ALTER TABLE movie CHANGE name name VARCHAR(100) NOT NULL, CHANGE description description LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie CHANGE name name VARCHAR(45) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE description description VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`');
        $this->addSql('CREATE UNIQUE INDEX id_UNIQUE ON movie (id)');
    }
}
